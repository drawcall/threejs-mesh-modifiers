...
export class MeshProxy {
	...
	public getMin(axis: number): number {
		switch (axis) {
			case ModConstant.X: return this._minX;
			case ModConstant.Y: return this._minY;
			case ModConstant.Z: return this._minZ;
		}
	...
	public getMax(axis: number): number {
		switch (axis) {
			case ModConstant.X: return this._maxX;
			case ModConstant.Y: return this._maxY;
			case ModConstant.Z: return this._maxZ;
		}
		return -1;
	}
	...
	public getSize(axis: number): number {
		switch (axis) {
			case ModConstant.X: return this._width;
			case ModConstant.Y: return this._height;
			case ModConstant.Z: return this._depth;
		}
		return -1;
	}
