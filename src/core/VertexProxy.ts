...
export class VertexProxy {
    ...
    public getValue(axis: number): number {
        switch (axis) {
            case ModConstant.X: return this.x;
            case ModConstant.Y: return this.y;
            case ModConstant.Z: return this.z;
        }
    ...
    public getRatio(axis: number): number {
        switch (axis) {
            case ModConstant.X: return this._ratioX;
            case ModConstant.Y: return this._ratioY;
            case ModConstant.Z: return this._ratioZ;
        }
        return -1;
    }
    ...
    public getOriginalValue(axis: number): number {
        switch (axis) {
            case ModConstant.X: return this.ox;
            case ModConstant.Y: return this.oy;
            case ModConstant.Z: return this.oz;
        }
        return 0;
    }
